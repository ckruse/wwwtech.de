defmodule Wwwtech.Pictures.Picture do
  ...
  def changeset(model, params \\ %{}) do
    model
    |> cast(params, [:title, :lang, :content, :posse, :author_id, :image_file_name, :image_content_type, :image_file_size,
      :image_updated_at, :show_in_index, :in_reply_to])
    |> validate_required([:title, :lang, :content, :posse, :author_id, :image_file_name, :image_content_type, :image_file_size,
      :image_updated_at, :show_in_index])
  end
