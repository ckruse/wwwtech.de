defmodule WwwtechWeb.Paging do
  defstruct [:per_page, :page, :limit, :offset, :all_entries_count, :pages_count, :distance]

  use Phoenix.HTML
  alias WwwtechWeb.Paging

  def paginate(data_count, opts \\ []) do
    config = Application.get_env(:wwwtech, :paginator)
  ...
  defp pages_list_start(%Paging{page: page, distance: distance}) do
  ...
  defp pages_list_end(%Paging{page: page, distance: distance, pages_count: pages_count}) do
    case page + distance do
